(function(joo_global_object)
   {"use strict";
    ...
    var
     ...
     _av_=[0,caml_new_string("src/blob.ml"),17,6];
    ...
    caml_register_global(266,Bin_prot_Std,"Bin_prot__Std");
    var
     _ap_=include[1],
     _aq_=include[3],
     _ar_=include[4],
    ...
    function bin_read_t$1(bin_read_a,buf,pos_ref)
     {var
      ...
      if((end_a - start_a | 0) !== expected_size)
       {var
         _aN_=
          caml_call3(Stdlib_printf[4],_aw_,end_a - start_a | 0,expected_size);
        caml_call1(Stdlib[3],_aN_)}
      return a}
    function bin_read_t$2(param,_aM_,pos_ref)
    ...
    var
     T$0=
      [0,bin_shape_t$1,bin_size_t$0,bin_write_t$1,bin_read_t$3,bin_read_t$4],
    ...
    function bin_write_t$3(buf,pos,t)
     {var
      ...
      blit_string_buf(_aH_,t,[0,pos$0],buf,size);
      return pos$0 + size | 0}
    function string_of_bigstring(buf,pos,len)
     {var str=caml_create_bytes(len);
      blit_buf_bytes([0,pos],buf,_aI_,str,len);
      return caml_call1(Stdlib_bytes[42],str)}
    ...
    function of_opaque_exn$0(buf,t,bin_reader_v)
     {var len=caml_ml_string_length(t);
      ...
      if(pos_ref[1] !== len)
       {var error=caml_call3(Stdlib_printf[4],_aJ_,len,pos_ref[1]);
      ...
      [0,
       ...
       [0,
        ...
        [0,
         ...
         of_opaque_exn$0]],
       Ignored];
    caml_register_global(268,Bin_prot_Blob,"Bin_prot__Blob");
    return}
